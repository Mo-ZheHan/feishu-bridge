...
# FeishuBridge — Claude / Codex CLI 飞书通知助手
...
FeishuBridge 最初 fork 自 [KaminDeng/agent_notifier](https://github.com/KaminDeng/agent_notifier)
（作者 kamin.deng），此后做了大量重写——主要是 macOS 适配与飞书交互层的重新设计。
感谢原作者打下的基础。原项目以 MIT 协议开源，其版权声明保留在 [LICENSE](./LICENSE) 中。

---

## License

[MIT](./LICENSE) — © 2026 Mo-ZheHan，基于 © 2026 kamin.deng 的原始项目。
