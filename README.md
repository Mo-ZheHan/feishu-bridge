...
# FeishuBridge — Feishu Notifications for Claude / Codex CLI
...
| Pain Point | How FeishuBridge Solves It |
|------------|------------------------------|
...
FeishuBridge began as a fork of [KaminDeng/agent_notifier](https://github.com/KaminDeng/agent_notifier)
by kamin.deng, and has since been substantially rewritten — notably a macOS adaptation
and a redesigned Feishu interaction layer. Many thanks to the original author for the
foundation. The original work is MIT-licensed and its copyright is retained in [LICENSE](./LICENSE).

---

## License

[MIT](./LICENSE) — © 2026 Mo-ZheHan, building on © 2026 kamin.deng.
